...
import { useNotificationPrompt } from "@/pwa/modules/home/hooks/useNotificationPrompt";
...
export function NotificationPrompt({ owner }: NotificationPromptProps) {
  const { mode, isOpen, isBusy, error, dismiss, activate } = useNotificationPrompt(owner);
